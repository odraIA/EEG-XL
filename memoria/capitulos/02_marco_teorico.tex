...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[align=center, font=\small] at (0,0.9) {Misma actividad\\neuronal subyacente};
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        win/.style={draw, rounded corners=1mm, minimum width=1.9cm,
        ...
        \node[win, below=17mm of w1] (x1) {$\mathbf{x}_1$\\ventana EEG/MEG};
