...
\newcommand{\footerlogos}{%
  \makebox[\footerlogowidth][c]{\includegraphics[height=6mm,keepaspectratio]{logo_upv.jpg}}%
  \makebox[\footerlogowidth][c]{\includegraphics[height=6mm,keepaspectratio]{logo_miarfid.png}}%
  \makebox[\footerlogowidth][c]{\includegraphics[height=6mm,keepaspectratio]{logo_dsiic.png}}%
  \makebox[\footerlogowidth][c]{\includegraphics[height=5mm,trim=25 115 25 115,clip,keepaspectratio]{logo_vrain.png}}%
}
...
\subtitle{Clasificación de palabras en escucha natural}
  ...
  \begin{columns}[c,totalwidth=\linewidth]
    \begin{column}{0.58\linewidth}
      ...
      \begin{block}{Por qué sigue siendo difícil}
        \begin{itemize}
          \item Señal cerebral no invasiva indirecta, ruidosa y variable.
          \item Cada palabra contexto temporal y lingüístico.
          \item Los datos cerebro--texto alineados son escasos y caros.
          \item Generalización sujetos, sesiones y datasets limitada.
        \end{itemize}
      \end{block}
    \end{column}
...
\begin{frame}[c]{Invasivo vs. no invasivo}
  ...
  \begin{columns}[c,totalwidth=\linewidth]
    \begin{column}{0.34\linewidth}
      \centering
      \includegraphics[width=\linewidth,height=0.29\textheight,keepaspectratio]{imagenes/ecog.jpg}\par
      \vspace{0.5mm}
      {\bfseries ECoG}\par
      \vspace{3mm}
...
% 5 ---------------------------------------------------------------------------
\begin{frame}[c]{Comparativa de métodos no invasivos}
  \small
  ...
  \begin{tabular}{>{\bfseries}p{0.10\linewidth}>{\centering\arraybackslash}p{0.12\linewidth}>{\centering\arraybackslash}p{0.12\linewidth}>{\centering\arraybackslash}p{0.10\linewidth}p{0.38\linewidth}}
    ...
    \midrule
    EEG & Alta & Baja & Bajo & BCI portable; ruidoso para texto natural \\
    MEG & Alta & Media & Alto & Aprender representación temporal lenguaje \\
    fMRI & Baja & Alta & Alto & Útil semántica; no nivel palabra tiempo real \\
    \bottomrule
  \end{tabular}
  \end{center}
  ...
  \begin{alertblock}{Hipótesis del TFM}
    MEG permite aprender representaciones de mayor calidad, ¿arquitectura de contexto largo entrenada con MEG punto de partida para EEG?.
  \end{alertblock}
  ...
  \begin{columns}[c,totalwidth=\linewidth]
    ...
    \begin{column}{0.59\linewidth}
      \begin{block}{Lo que mide}
        Diferencias potencial cuero cabelludo, generadas por actividad neuronal sincronizada observada por electrodos.
      \end{block}
      ...
      \begin{exampleblock}{Resumen}
        Registra señales microvoltios con  mucho ruido. Por eso hacen falta preprocesamiento, contexto largo y preentrenamiento.
      \end{exampleblock}
    \end{column}
  \end{columns}
...
\begin{frame}{Momento casco}
  \begin{tikzpicture}[remember picture,overlay]
    \node[anchor=south east,inner sep=0pt]
      at ([yshift=8.4mm]current page.south east) {%
        \includegraphics[height=0.814\paperheight,keepaspectratio]{openbci_software.jpg}%
      };
    \node[inner sep=0pt]
      at ([xshift=32.4mm]current page.west) {%
        \includegraphics[width=0.24\paperwidth,keepaspectratio]{openbci_helmet.png}%
      };
  \end{tikzpicture}
\end{frame}

\section{Hipótesis y propuesta}
  ...
  \begin{columns}[T,totalwidth=\linewidth]
    ...
    \begin{column}{0.36\linewidth}
      \begin{block}{Idea central}
        Modelo pocos parámetros capaz de entender MEG y especializar con pocos datos.
      \end{block}
    ...
    \begin{column}{0.55\linewidth}
      ...
      \begin{tikzpicture}[node distance=4mm, every node/.style={font=\scriptsize}]
        \node[draw=deepgreen, fill=deepgreen!8, rounded corners, text width=46mm, align=center] (a) {\textbf{1. Señal M/EEG continua}\\ventanas de 150 s};
  ...
  \begin{columns}[c,totalwidth=\linewidth]
    \begin{column}{0.44\linewidth}
      ...
      \begin{center}
        ...
        \smallmetric{$\sim$20\%}{estado del arte comparable en ds004408}
        \vspace{2mm}
    ...
    \begin{column}{0.52\linewidth}
      ...
      \begin{exampleblock}{Lectura principal}
        Se supera la referencia aproximada de d'Ascoli et al. ($\sim$20\%) en la misma métrica: +2,32 pp. La comparación es descriptiva.
      \end{exampleblock}
    \end{column}
  \end{columns}
...
% 15 --------------------------------------------------------------------------
\begin{frame}[c]{Interpretación resultados}
  \small
  \begin{columns}[T,totalwidth=\linewidth]
    \begin{column}{0.30\linewidth}
      \begin{block}{Viabilidad}
        ...
        \begin{itemize}
          \item Arquitectura puede adaptarse a EEG.
          \item Sistema supera el azar.
          \item Contexto largo compatible también con EEG.
        \end{itemize}
        \end{minipage}
      \end{block}
    \end{column}
    ...
    \begin{column}{0.30\linewidth}
      \begin{block}{Qué aporta más}
        \begin{minipage}[t][30mm][t]{\linewidth}
        \begin{itemize}
          \item Mayor salto viene del preentrenamiento EEG.
          \item MEG-XL aporta una mejora adicional moderada.
          \item Embedding MEG reutilizado mejor en esta ejecución.
        \end{itemize}
        \end{minipage}
      \end{block}
    \end{column}
    ...
    \begin{column}{0.30\linewidth}
      \begin{alertblock}{Cuidado}
        ...
        \begin{itemize}
          ...
          \item Perdemos info por Nyquist.
          \item No generación libre de texto.
        \end{itemize}
        \end{minipage}
      \end{alertblock}
    \end{column}
...
\begin{frame}[c]{Conclusiones}
  ...
  \begin{columns}[c,totalwidth=\linewidth]
    \begin{column}{0.40\linewidth}
      ...
      \begin{exampleblock}{Resultado central}
        \begin{itemize}
          \item 22,32\% Top-10 balanceada.
          \item Supera estado arte menos parámetros.
    ...
    \begin{column}{0.56\linewidth}
      \begin{block}{Trabajo futuro}
        \begin{itemize}
          ...
          \item Posible paper si confirma mejora sobre el estado arte.
          \item Más bandas, remuestreos, tokenizadores y datasets.
          \item Separar embeddings por zonas del cerebro.
          \item Agregar LLMs para generación libre de texto.
          \item Probar modelo con registros propios con casco EEG.
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}
  \begin{columns}[c,totalwidth=\linewidth]
    ...
    \begin{column}{0.5\linewidth}
      \centering
      \hspace*{-8mm}\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{imagenes/luffy_transparent_2.png}
    \end{column}
  \end{columns}
\end{frame}
}
